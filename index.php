                ...
                <form class="d-flex flex-column align-items-start" action="index.php?test=test">
                    <div class="mb-2">
                        ...
                        <select class="form-select w-auto" name="limit">
                            <option value="10"<?=if($perPage=="10"){echo 'selected'}?>>10</option>
                    ...
                    <div class="mb-2">
                        ...
                        <select class="form-select w-auto" name="sort">
                            <option value="title"<?=if($sort=="title"){echo 'selected'}?>>Le nom du film</option>
                            <option value="type"<?=if($sort=="type"){echo 'selected'}?>>Le genre du film</option>
                            <option value="rentals"<?=if($sort=="rentals"){echo 'selected'}?>>Le nombre de location</option>
                        </select>
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Par ordre :</label>
                        <select class="form-select w-auto" name="direction">
                            <option value="ASC"<?=if($direction=="ASC"){echo 'selected'}?>>Croissant</option>
                            <option value="DESC"<?=if($direction=="DESC"){echo 'selected'}?>>Décroissant</option>
                        </select>
                    </div>
